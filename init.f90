...
!-----------------------------------------------------------------------------------------------------------------------
 real*8, dimension(mx,my) :: theta, phi
 real*8, dimension(mx)    :: xi, tanxi
 real*8, dimension(my)    :: eta, taneta
 real*8, dimension(mr)    :: r, chi
 ...
 real*8, dimension(mx,my) :: metric_delta, XY, CD, sqrt_metric_delta
 real*8, dimension(mx)    :: metric_C
 real*8, dimension(my)    :: metric_D
 real*8, dimension(mr)    :: drdchi
...
! Lagrange time interpolation stuff
 ...
 real*8, dimension(mx,my) :: LC0, LC1, LC2, LC3, LC4, LC5, LC6
